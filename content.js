...
function playTestSound() {
  ...
  audio
    ...
    .then(function () {
      ...
      alert(
        "This is your test sound! This means you have allowed sound. The page will now ring 5 times when it's your turn to sign up for the vaccine."
      );
      ...
      if (confirm('Do you want to set a callback url? (webhook)')) {
        var url = prompt('Enter your url', 'https://');
        url && window.sessionStorage.setItem('callbackUrl', url);
      }
...
// Because of CORS we can only setup get-requests to webhooks that allow it...
function callback() {
